...
def is_attribute(klass, attr, value):
...
def is_property_method(klass, attr, value):
...
def is_regular_method(klass, attr, value):
...
def is_static_method(klass, attr, value):
...
def is_class_method(klass, attr, value):
